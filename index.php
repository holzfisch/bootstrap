...
<meta name="description"
	content="Hausaufgabe MOOC Web-Engeneering 2013 I">
...
<body>
	...
	<div class="seite">
		...
		<div class="kopf">
			<h1>Moinsens,</h1>
			<p class="lead">von Harten wellkomen up de Siede von den
		...
		<div class="row-fluid inhalt">
			<div class="span12">
				<article>Dat aller Neeste över dat Tüffeltuten und wat ook noch
					daarto hören dot.</article>
			</div>
		</div>
		...
		<div class="row-fluid inhalt">
			...
			<div class="span6">
				...
				<article>
					<h4>GIT-Tutorial</h4>
					<p>
						Äh, wo war nochmal die letzte Version? Wie, weg?<br /> Och nö,
						menno kann doch nich war sein. Geht das nicht anders? Das Chaos
						bändigen? Oder einfach nur durchblicken und doch mal fertig
						werden?<br /> <a class="btn btn-info"
							href='http://git.storchbraterei.de' target='_blank'>Doch hier
							gehts lang</a>
					</p>
				</article>
			...
			<div class="span6">
				<article>
					...
					<p>
						<a href="http://slipsum.com" target='_blank'>a much less offensive
							placeholder text generator!</a>
					</p>
					<!-- start slipsum code -->
				...
				<article>
					...
					<p>
						<a class="btn btn-block btn-large btn-danger"
							href='http://lmgtfy.com/?q=Wo+ist+der+Rest%3F' target='_blank'>na
							Hier</a>
					</p>
				</article>
		...
		<footer class="footer">
			<hr />
			<div class='pull-left'>
				<?php echo $_SERVER['HTTP_USER_AGENT'] . "<br />" . $_SERVER['REMOTE_ADDR'] . "<br />" . date("d.m.Y"); ?>
			</div>
			<div class='pull-right'>
				<a
					href="http://validator.w3.org/check?uri=bootstrap.storchbraterei.de"
